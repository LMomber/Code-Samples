...
DescriptorAllocation::DescriptorAllocation(D3D12_CPU_DESCRIPTOR_HANDLE descriptor,
    ...
    : m_Descriptor(descriptor), m_NumHandles(numHandles), m_DescriptorSize(descriptorSize), m_Page(page)
{
}
...
bool DescriptorAllocation::IsNull() const { return m_Descriptor.ptr == 0; }
