...
{
public:
    MakeAdapter(Microsoft::WRL::ComPtr<IDXGIAdapter4> dxgiAdapter) : Adapter(dxgiAdapter) {}
...
const std::wstring Adapter::GetDescription() const { return m_Desc.Description; }

Adapter::Adapter(Microsoft::WRL::ComPtr<IDXGIAdapter4> dxgiAdapter) : m_dxgiAdapter(dxgiAdapter), m_Desc{0}
{
    if (m_dxgiAdapter)
    {
